...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    <div id="skip-to-nav"><a href="#block-menu-primary-links" id="navigation-top"><?php print t('Skip to Navigation'); ?></a></div>
        ...
        <?php if ($breadcrumb or $title or $tabs or $help or $messages): ?>
          <div id="content-header">
           <?php print $breadcrumb; ?>
         	<div id="homebanner">
        	  <img src="<?php print $directory; ?>/img/homepics.jpg" alt="collage of pics" />
        	</div><!-- /#homebanner -->
        	<div id="homepic">
        		<img src="<?php print $directory; ?>/img/ilove.png" alt="I love ITC --by Olivia" />
        	</div><!-- /#homepic -->
            <?php if ($title): ?>
